        ...
        foreach ($sections as $idx => $sect) {
            ...
            case 'general':
                ...
                if (!isset($no_override['skin'])) {
                    ...
                    // as we're using custom BareMetalEmail skin, other skins are not supported
                    continue;
            ...
            case 'customization':
                ...
                // Product name
                if (!isset($no_override['product_name'])) {
                    if (!$current) {
                        continue 2;
                    }

                    $field_id = 'rcmfd_product_name';
                    $input    = new html_inputfield([
                                                        'name'  => '_product_name',
                                                        'id'    => $field_id,
                                                        'size'  => 5,
                ...
                // Custom logo
                if(!isset($no_override['custom_logo'])) {
                    if(!$current) {
                        continue 2;
                    }
                ...
                // Custom favicon
                if(!isset($no_override['custom_favicon'])) {
                    if(!$current) {
                        continue 2;
                    }
